...
public class TextFieldBoxes extends FrameLayout {
    ...
    private int DEFAULT_DISABLED_TEXT_COLOR;
    private int DEFAULT_BG_COLOR;
    private int DEFAULT_FG_COLOR;
     ...
     */
    private int iconSignifierResourceId;
     ...
     */
    private boolean isResponsiveIconColor;
     ...
     */
    private boolean useDenseSpacing;
     ...
     */
    private boolean isManualValidateError = false;

    private View panel;
    private View bottomLine;
    private Space labelSpace;
    private Space labelSpaceBelow;
    private ViewGroup editTextLayout;
    private ExtendedEditText editText;
    private RelativeLayout rightShell;
    private RelativeLayout upperPanel;
    private RelativeLayout bottomPart;
    private RelativeLayout inputLayout;
    private AppCompatTextView helperLabel;
    private AppCompatTextView counterLabel;
    private AppCompatTextView floatingLabel;
    private AppCompatImageButton clearButton;
    private AppCompatImageButton iconImageButton;
    private AppCompatImageButton endIconImageButton;
    private InputMethodManager inputMethodManager;

    private SimpleTextChangedWatcher textChangeListener;
    ...
    private void initDefaultColor() {
        ...
        if (isLight(DEFAULT_BG_COLOR))
            DEFAULT_PRIMARY_COLOR = lighter(themeArray.getColor(0, 0));
    ...
    private ExtendedEditText findEditTextChild() {
    ...
    private void initViews() {
        ...
        this.labelTopMargin = Objects.requireNonNull((RelativeLayout.LayoutParams) this.floatingLabel.getLayoutParams()).topMargin;
     ...
     */
    private void activate(boolean animated) {
     ...
     */
    private void setHighlightColor(int colorRes) {
     ...
     */
    private boolean validate() { //Reverted: "validateError" has the opposite meaning and is incorrect and does not follow conventions
        removeError();
     ...
     */
    private void updateDimens(boolean useDenseSpacing) {
     ...
     */
    private void updateCounterText(boolean performValidation) {
     ...
     */
    private void removeCounterError() {
        this.onError = false;
    ...
    /* Color Setters */
    private void setHelperTextColor(int colorRes) {

        this.helperTextColor = colorRes;
        this.helperLabel.setTextColor(this.helperTextColor);
    }

    private void setCounterTextColor(int colorRes) {

        this.counterTextColor = colorRes;
        this.counterLabel.setTextColor(this.counterTextColor);
    }

    private void setErrorColor(int colorRes) {
     ...
     */
    private void setPrimaryColor(int colorRes) {

        this.primaryColor = colorRes;
        if (this.hasFocus) setHighlightColor(this.primaryColor);
    }

    private void setSecondaryColor(int colorRes) {

        this.secondaryColor = colorRes;
        if (!this.hasFocus) setHighlightColor(this.secondaryColor);
    }

    private void setPanelBackgroundColor(int colorRes) {
    ...
    private void setMinCharacters(int minCharacters) {
    ...
    private void setIconSignifier(int resourceID) {
     ...
     */
    private void removeIconSignifier() {
     ...
     */
    private void setIsResponsiveIconColor(boolean isResponsiveIconColor) {
    ...
    private void setAlwaysShowHint(boolean alwaysShowHint) {
        this.alwaysShowHint = alwaysShowHint;
    }

    private void setUseDenseSpacing(boolean useDenseSpacing) {
    ...
    private boolean getIsResponsiveIconColor() {
    ...
    private static void setCursorDrawableColor(EditText _editText, int _colorRes) {
        ...
        try {
            ...
            Objects.requireNonNull(drawables[0]).setColorFilter(_colorRes, PorterDuff.Mode.SRC_IN);
            Objects.requireNonNull(drawables[1]).setColorFilter(_colorRes, PorterDuff.Mode.SRC_IN);
    ...
    private static int lighter(int color) {
        ...
        int red = (int) ((Color.red(color) * (1 - 0.2f) / 255 + 0.2f) * 255);
        int green = (int) ((Color.green(color) * (1 - 0.2f) / 255 + 0.2f) * 255);
        int blue = (int) ((Color.blue(color) * (1 - 0.2f) / 255 + 0.2f) * 255);
     ...
     */
    private static int adjustAlpha(int color, float _toAlpha) {
